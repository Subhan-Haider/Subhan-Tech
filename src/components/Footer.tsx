        ...
        <footer className="py-12 px-6 border-t border-white/5 relative overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="flex flex-col items-center md:items-start gap-2">
                    <h2 className="text-xl font-bold text-glow">SUBHAN<span className="text-white/20">.TECH</span></h2>
                    <p className="text-sm text-muted-foreground">© 2026 Neural Engineering Lab. All rights reserved.</p>
                </div>

                <div className="flex items-center gap-6">
                    <Link href="/admin" className="text-[10px] font-bold uppercase tracking-widest text-white/20 hover:text-white transition-colors border border-white/5 px-3 py-1 rounded-full cursor-pointer">
                        Access HQ
                    </Link>
